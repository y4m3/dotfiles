#!/usr/bin/env bash
# 299-zoxide.sh — Tool configuration: zoxide
# Category: 200-299 (Runtime initialization - must be loaded last)
# See: https://github.com/ajeetdsouza/zoxide
# Note: zoxide must be initialized at the end of shell configuration to avoid conflicts
