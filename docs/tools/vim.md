...
- **vim-gtk3** installed via `run_once_000-prerequisites.sh.tmpl` (provides `+clipboard` support)
- Configuration template: `home/dot_vimrc.tmpl`
- Colorscheme installed via `run_once_220-shell-vim-tokyonight.sh.tmpl`
